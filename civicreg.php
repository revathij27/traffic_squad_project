          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="admin/template/images/logo-dark.svg" alt="logo">
              </div>
              <h4>New here?</h4>
              ...
              <form class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="admin/template/index.html">SIGN UP</a>
                </div>
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="civiclogin.php" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
